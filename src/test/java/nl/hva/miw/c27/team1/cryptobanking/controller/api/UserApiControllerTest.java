...
class UserApiControllerTest {
    ...
    @MockBean
    private PepperService mockPepperService;

    @MockBean
    private AuthenticationService mockAuthenticationService;

    @Autowired
    public UserApiControllerTest(MockMvc mockMvc, UserService mockUserService, HashService mockHashService, PepperService mockPepperService, AuthenticationService mockAuthenticationService) {
        super();
        this.mockMvc = mockMvc;
        this.mockHashService = mockHashService;
        this.mockUserService = mockUserService;
        this.mockPepperService = mockPepperService;
        this.mockAuthenticationService = mockAuthenticationService;
    }

    @Test //todo repair broken test due to change in Profile class!

    void register() throws Exception {
        Customer customer = new Customer(0, "de", "Burcht", "test", 191222333,
                new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"), "Straat",
                "30", "1111AA", "Hilversum",
                "Netherlands");


        //, new Profile("profile", "hash", "salt", "userEnteredPassword"),
